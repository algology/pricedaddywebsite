...
export default function Home() {
  return (
    <>
      <Head>
        <title>
          PriceDaddy - Reveal Price Information on Real Estate Listings
        </title>
        <meta
          name="description"
          content="PriceDaddy uncovers price information on any realestate.com.au property listing. Discover days on market, page views, and cost per square meter for every listing."
        />
      ...
      <main className="w-full h-auto">
            ...
            <div className="sm:mt-[150px] mt-[60px] grid place-items-center gap-4 sm:gap-10 sm:px-5 px-2">
              ...
              <div className="text-center max-w-md">
                <p className="md:text-[20px] text-[16px] leading-[150%] max-w-xl text-[#666666]">
                  PriceDaddy! uncovers price information on any
        ...
        <section className="w-full max-w-7xl mx-auto py-10 px-5 sm:px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-5 items-center py-8 justify-center">
            ...
            <p className="text-center">5 star review on Google</p>
          </div>
        </section>
