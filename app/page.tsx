...
export default function Home() {
  return (
    <>
      <Head>
        <title>PriceDaddy - Detailed Property Information for Australian House Buyers</title>
        <meta name="description" content="PriceDaddy! helps Australian house buyers get more detailed property information on realestate.com.au listings. Get insights on NBN connection, price guides, walkability scores, transit scores, days on market, and popularity of listings." />
      </Head>
            ...
            <div className="sm:mt-[150px] mt-[60px] grid place-items-center gap-4 sm:gap-10 sm:px-5 px-2">
              ...
              <div className="text-center max-w-md">
                <p className="md:text-[20px] text-[16px] leading-[150%] max-w-xl text-[#666666]">
                  ...
                  property listing, including NBN connection, price guides, walkability scores, transit scores, and more.
                </p>
              </div>
          ...
          <section className="w-full max-w-7xl mx-auto px-5 sm:px-2">
            <div className="flex flex-col gap-10">
              ...
              <div className="sm:p-10 p-5 w-full rounded-full  flex flex-row gap-3 justify-center">
                <Image src={coding} alt="More features coming soon" width={512} height={512} />
              </div>
            </div>
          </section>
        </div>
