...
const Header = () => {
  return (
    <header className="sticky top-0 z-50 w-full border-border/90 bg-background/40 backdrop-blur supports-\[backdrop-filter\]:bg-background/60">
      <div className="container mx-auto flex h-24 items-center py-20 max-w-7xl">
        <div className="flex items-center">
          <Link href="/" className="flex items-center logo-animation">
            ...
            <span className="ml-2 font-bold lg:text-4xl text-2xl px-2">
              PriceDaddy!
            </span>
          </Link>
        </div>
